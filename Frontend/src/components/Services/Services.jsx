        ...
        <div className="row gy-4">
          <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div className="service-item position-relative">
              ...
              <a href="/services#comprehensive-eye-exams" className="stretched-link">
          ...
          <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div className="service-item position-relative">
              ...
              <a href="/services#prescription-eyewear" className="stretched-link">
          ...
          <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div className="service-item position-relative">
              ...
              <a href="/services#surgical-treatments" className="stretched-link">
          ...
          <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div className="service-item position-relative">
              ...
              <a href="/services#diagnostic-services" className="stretched-link">
          ...
          <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div className="service-item position-relative">
              ...
              <a href="/services#emergency-eye-care" className="stretched-link">
          ...
          <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div className="service-item position-relative">
              ...
              <a href="/services#patient-education" className="stretched-link">
